...
<body>
        ...
        <div class="breadcrumbs">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <a href="decoded.php"><button  role="button" class="btn-btn btn-md btn-danger" value="View More">Back</button></a>
                        </ol>
                    </div>
                </div>
            </div>
            <div class="col-sm-2">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <a href="decoded3.php"><button  role="button" class="btn-btn btn-md btn-success" value="View More">Next</button></a>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <table class="table table-bordered" style="padding-left: -4px;color: #558B2F">
      <thead style="color: green">
        ...
        <th scope="col">MSLP</th><th scope="col">Rainfall.Duration</th><th scope="col">Present.Weather</th><th scope="col">Past.Weather</th><th scope="col">L.Cloud</th><th scope="col">M.Cloud</th><th>H.Cloud</th><!-- <th scope="col">Param.12</th>
    ...
    $sql10="SELECT lowcloud_description FROM low_cloud WHERE lowcloud_id='$lowcloud_id'";
        ...
        echo "<tr><td>".$row['mslp']."</td><td>".($row['r1'].$row['r2'].$row['r3'].'mm of Rainfall in the last '.$row['tr']*'4'.' hrs')."</td><td>".$row_main2['presentweather_description']."</td><td>".$row_main3['pastweather_description']."</td><td>".$row_main9['lowcloud_description']."</td><td>".$row_main8['mediumcloud_description']."</td><td>".$row_main5['highcloud_description']."</td>";  
