    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
            ...
            <div class="header-menu">
                ...
                <div class="col-sm-7">
                    <h5>MET. Stations Collectives</h5>
                    ...
                    <form action="searchdecoded.php" method="post">
                        <div class="form-group">                           
                            ...
                            <input type="text" name="days" value="<?php echo date("d/m/Y");?>" class="form-control">                                
                              ...
                              <input type="submit" name="submit" class="btn-btn  btn-success" value="Search">                                 
                            </div>
                        </div>
                    </form>
                    </div>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <a href="decoded2.php"><button  role="button" class="btn-btn btn-md btn-success" value="View More">Next Page</button></a>
                        </ol>
                    </div>
                </div>
            </div> 
...
<div class="container">
    ...
    <table class="table table-stripped" style="padding-left: -4px;color: #558B2F;">
      <thead style="color: green">
        ...
        <th scope="col">HeightOfLC</th><th scope="col">Visibility</th><th scope="col">Wind.Direction</th><th scope="col">Wind.Speed</th><th scope="col">Dry.Bulb.Temp</th><th scope="col">Dew.Point</th><!-- <th scope="col">MSLP</th> -->
        <!-- <th scope="col">Rainfall.Duration</th> --><!-- <th scope="col">Present.Weather</th><th scope="col">Past.Weather</th><th scope="col">Low.Cloud</th><th scope="col">Medium.Cloud</th><th>High.Cloud</th><th scope="col">Param.9</th><th scope="col">Param.10</th>
    ...
    $sql = "SELECT `day`, `Hour`, `location_id`, `stationnos_id`, `h`, `visibility_id`, `winddirection_id`, `ff`, `temp1`, `temp2`, `r1`, `r2`, `r3`, `tr`, `presentweather_id`, `pastweather_id`, `lowcloud_id`, `mediumcloud_id`, `highcloud_id`, `atherm`, `levelpress`, `baroread`, `wetbulb`, `rhumidity`, `vappressure` FROM `decoded`WHERE (day='$date')ORDER BY hour desc";
    ...
    $sql10="SELECT lowcloud_description FROM low_cloud WHERE lowcloud_id='$lowcloud_id'";
        ...
        echo "<tr><td>".$row["day"]."</td><td>".$row["Hour"]."</td><td>".$row_main6['location_name']."</td><td>".$row_main7['station_nos']."</td><td>".$row['h']."</td><td>".$row_main['visibility_description'].'km'."</td><td>".$row_main4['direction']."</td><td>".$row['ff'].' knots'."</td><td>".$row['temp1'].' C'."</td><td>".$row['temp2'].' C'."</td>";  
