            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title col-md-12">
                        <h1>Hourly Collectives From MET. Stations</h1>
                    </div>
                </div>
            </div>
             <div class="col-sm-3">
                    <form action="searchdecoded2.php" method="post">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <a href="searchdecoded.php"><button  role="button" class="btn-btn btn-md btn-success" value="View More">Back</button></a>
                        </ol>
                    </div>
                </div>
            </div>
...
<div class="container">  
    ...
    <table class="table table-bordered" style="padding-left: -4px;color: #558B2F">
      <thead style="color: green">
        ...
        <th scope="col">Date</th><th scope="col">GMT(Hr)</th><th>Station</th><th>Station_no</th><th scope="col">Rainfall.Duration</th><th scope="col">Present.Weather</th><th scope="col">Past.Weather</th><th scope="col">Low.Cloud</th><th scope="col">Medium.Cloud</th><th>High.Cloud</th><!-- <th scope="col">Param.12</th>
...
$location_id = mysqli_real_escape_string($conn, $_POST['loca']);
    ...
    $sql10="SELECT lowcloud_description FROM low_cloud WHERE lowcloud_id='$lowcloud_id'";
        ...
        echo "<tr><td>".$row["day"]."</td><td>".$row["Hour"]."</td><td>".$row_main6['location_name']."</td><td>".$row_main7['station_nos']."</td><td>".($row['r1'].$row['r2'].$row['r3'].'mm of Rainfall in the last '.$row['tr']*'4'.' hrs')."</td><td>".$row_main2['presentweather_description']."</td><td>".$row_main3['pastweather_description']."</td><td>".$row_main9['lowcloud_description']."</td><td>".$row_main8['mediumcloud_description']."</td><td>".$row_main5['highcloud_description']."</td>";  
