...
<h4 align="" style="font-family: Georgia, serif;">Marine Hourly Weather Collectives</h4></div>
<div class="card-body">
             <div class="col-sm-12">
                 <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <a href="marinecollective.php"><button  role="button" class="btn-btn btn-md btn-primary" value="View More">Back</button></a>
                        </ol>
                    </div>
                </div>
...
$days = mysqli_real_escape_string($conn, $_POST['days']);
    ...
    $sql = "SELECT day,location_id,hour,tidal_height,tidal_movement FROM marine_weather WHERE(day='$days'AND location_id='$location_id') ORDER BY day desc,hour desc";
